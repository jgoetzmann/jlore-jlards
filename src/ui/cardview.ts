/**
 * A `CardView` built from a printed definition. Ported from the parked
 * animation pass (c67cf3f).
 *
...
/**
 * @param key the option key, used as a stand-in instance id so React has
