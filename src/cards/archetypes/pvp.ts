...
export const cards: CardDefinition[] = [
  ...
  },
  {
    ...
    text: '+1 Action. Until your next turn, an opponent who buys a card costing (6) or more also gains a Cursed Pig.',
  ...
  },
  {
    ...
    triggers: [],
    text: 'Add a copy of the last card an opponent discarded to your GY. You see it first.',
  ...
  },
  {
    ...
    triggers: [],
    text: 'Play on Buy. Flimsy. The game ends 3 turns from now.',
